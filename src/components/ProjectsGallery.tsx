...
const projects = [
  ...
  },
  {
    ...
    description: `An Android app built in Java using Accessibility Services to automate ad skipping on YouTube, improving user experience through seamless UI interaction. It features a lightweight interface with real-time ad detection and currently serves over 50 real users.`,
    repo: "https://play.google.com/store/apps/details?id=com.pgarc.skipper",
    tech: ["Java", "Android Accessibility Services"],
